...
import com.itheima.ssm.utils.Date2StringUtils;
...
public class Product {
    ...
    public String getDepartureTimeStr() {
        System.out.println("departureTimeStr..."+departureTimeStr);
        if(departureTime!=null){
            //调用工具类，将date类型转换为String类型
            departureTimeStr = Date2StringUtils.date2String(departureTime, "yyyy-MM-dd HH:mm");
        }
...
//        productStatus 后端处理表查询数据与要封装进的实体类属性不匹配的问题
        // 状态 0 关闭 1 开启
        if(productStatus==0){
            productStatusStr="关闭";
